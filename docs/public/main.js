...
/* -- PROJECT BOX -- */
sr.reveal('.reflexion',{interval: 200})
...
srLeft.reveal('.sobreMi-info',{delay: 100})
srLeft.reveal('.contacto-info',{delay: 100})
...
function redireccionarLinkedIn() {
  window.open('https://www.linkedin.com/in/gian-janampa/', '_blank');
}

function redireccionarGitHub() {
  window.open('https://github.com/GianAS1012', '_blank');
}
